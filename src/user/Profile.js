	...
	return (
		<Form>
			...
			<Formik>
				<Form.Field>
					<label>使用者名稱：</label>
					<Field name="user" type="text" placeholder="名稱" component={Input.Text} />
				...
				<Form.Field>
					<label>手機驗證：</label>
					<Field name="phone" type="phone" placeholder="手機號碼" component={Input.Text} />
